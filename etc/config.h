...
#FC = mpif90
#FFLAGS =   -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -lm -O4 -check nobounds -xAVX -ftz -assume buffered_io -assume byterecl  -implicitnone -warn truncated_source -warn argument_checking -warn declarations -warn alignments -warn ignore_loc -warn usage -mcmodel=medium -shared-intel
...
FFLAGS= -l lapack -w -g -ffixed-line-length-256 -std=gnu  -fimplicit-none -frange-check -O2 -pedantic -pedantic-errors -Waliasing -Wampersand -Wline-truncation -Wsurprising -Wunderflow -fbounds-check 
